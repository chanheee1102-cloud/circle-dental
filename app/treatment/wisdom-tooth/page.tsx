 ...
 */
const LEAD =
  '사랑니는 가장 안쪽 어금니인 제3대구치입니다. **모두 빼야 하는 것은 아닙니다**. 매복 깊이와 인접치·신경관과의 위치 관계에 따라 발치 필요성이 갈리므로, 방사선 사진으로 위치를 먼저 확인합니다.';
 ...
 */
const RISKS = [
  '발치한 자리에는 이삼일 붓기와 통증이 있을 수 있고, 사흘째쯤 가장 심했다가 줄어듭니다.',
