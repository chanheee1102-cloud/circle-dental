    ...
    <section className="relative flex min-h-[92vh] items-center overflow-hidden">
      ...
      */}
      <div className="relative w-full px-6 pb-[190px] lg:px-16">
        <p className="sp-label sp-rise text-white/70" style={{ animationDelay: '80ms' }}>
          {CLINIC.nameEn}
        </p>
        ...
        */}
        ...
        <p
          className="sp-rise mt-8 max-w-[38ch] text-[14px] leading-[2] text-white/75"
      ...
      {items.map((it, i) => (
        <li key={it.label}>
          <a
            ...
            rel="noreferrer"
            title={it.title}
            className="sp-rise flex h-11 w-[168px] items-center gap-3 rounded-full bg-white/92 pl-5 text-[12px] tracking-[0.16em] text-[color:var(--sp-ink)] backdrop-blur transition-colors duration-500 hover:bg-white"
    ...
    <section className={`${SECTION} sp-reveal`}>
      <div className="mx-auto grid max-w-[1560px] gap-14 lg:grid-cols-[minmax(0,360px)_minmax(0,1fr)] lg:gap-20">
        <div className="lg:pt-10">
          ...
          <p className="mt-7 max-w-[34ch] text-[13.5px] leading-[2.05] text-[color:var(--sp-dim)]">
              ...
              <li key={d.slug} className="flex w-[min(88vw,740px)] flex-none snap-start">
                ...
                */}
                ...
                <div className="flex-1 bg-[color:var(--sp-band)] px-7 py-8">
                  <p className="text-[12px] tracking-[0.14em] text-[color:var(--sp-dim)]">
                    {d.role}
                  </p>
                  ...
                  <ul className="mt-6 space-y-2">
                    {d.career.slice(0, 5).map((c) => (
                      <li
                        key={c}
                        className="flex gap-2 text-[12.5px] leading-[1.75] text-[color:var(--sp-dim)]"
                      >
            ...
            return (
              <li key={p.key}>
                <Link href={p.href} className="group block w-[min(74vw,268px)] text-center">
                  ...
                  <span className="mt-6 block px-3 text-[12.5px] leading-[1.9] text-[color:var(--sp-dim)]">
                    {p.copy}
                  </span>
                </Link>
              </li>
      ...
      <div className="mx-auto grid max-w-[1560px] items-center gap-12 px-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,430px)] lg:gap-20 lg:px-10">
        ...
        */}
        ...
        <div className="lg:text-right">
          ...
          <p className="mt-7 text-[13.5px] leading-[2.05] text-[color:var(--sp-dim)] lg:ml-auto lg:max-w-[34ch]">
  ...
  return (
    <section className="sp-reveal relative flex min-h-[72vh] items-center justify-center overflow-hidden">
      ...
      <div className="relative px-6 text-center">
        <p className="sp-label !text-white/70">CIRCLE DENTAL CLINIC</p>
      ...
      <div className="mx-auto max-w-[1560px]">
        <div className="grid gap-14 lg:grid-cols-[minmax(0,420px)_minmax(0,1fr)] lg:gap-24">
          <div>
            ...
            <p className="mt-7 text-[13.5px] leading-[2.05] text-[color:var(--sp-dim)]">
              {CLINIC.address.full}
              <br />
          ...
          <dl className="grid gap-x-12 gap-y-6 sm:grid-cols-2">
            {hours.display.map((h: { label: string; time: string; note?: string }) => (
              <div key={h.label} className="border-t border-[color:var(--sp-line)] pt-5">
                ...
                <dd className="mt-3 text-[15px] tracking-[0.02em]">
                  {h.time}
                  {h.note && (
                    <span className="ml-2 text-[12px] text-[color:var(--sp-dim)]">{h.note}</span>
                  )}
                </dd>
              </div>
            ))}
            <div className="border-t border-[color:var(--sp-line)] pt-5 sm:col-span-2">
              ...
              <dd className="mt-3 text-[15px]">{hours.closed}</dd>
            </div>
          </dl>
        </div>
